...
type Account struct {
	...
	UserId        string     `gorm:"column:user_id;uniqueIndex:uk_app_user;comment:用户ID" json:"user_id"`  // 用户ID
	...
	IsAdmin       int8       `gorm:"column:is_admin;default:0;index;comment:是否管理员 0否 1是" json:"is_admin"` // 是否管理员 0否 1是
