...
const (
	...
	AccountOnlineLoginStateNormal  = 0
	AccountOnlineLoginStateTimeout = 1
	AccountOnlineLoginStateServer  = 2
)
...
type AccountOnline struct {
	...
	LogoutState int8       `gorm:"column:logout_state;default:0;comment:登出状态 0:正常退出 1:超时退出 2:服务端退出" json:"logout_state"`
