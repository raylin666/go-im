...
func newC2CMessage(db *gorm.DB, opts ...gen.DOOption) c2CMessage {
	...
	_c2CMessage.FromAccountId = field.NewString(tableName, "from_account_id")
	_c2CMessage.ToAccountId = field.NewString(tableName, "to_account_id")
	_c2CMessage.MsgType = field.NewString(tableName, "msg_type")
	...
	_c2CMessage.RevokeTime = field.NewTime(tableName, "revoke_time")
	_c2CMessage.SendTime = field.NewTime(tableName, "send_time")
	_c2CMessage.FromDeleteTime = field.NewTime(tableName, "from_delete_time")
	_c2CMessage.ToDeleteTime = field.NewTime(tableName, "to_delete_time")
...
type c2CMessage struct {
	...
	FromAccountId  field.String
	ToAccountId    field.String
	MsgType        field.String
	Data           field.String
	Status         field.Int8
	IsRevoke       field.Int8
	RevokeTime     field.Time
	SendTime       field.Time
	FromDeleteTime field.Time
	ToDeleteTime   field.Time
...
func (c *c2CMessage) updateTableName(table string) *c2CMessage {
	...
	c.FromAccountId = field.NewString(table, "from_account_id")
	c.ToAccountId = field.NewString(table, "to_account_id")
	c.MsgType = field.NewString(table, "msg_type")
	c.Data = field.NewString(table, "data")
	c.Status = field.NewInt8(table, "status")
	c.IsRevoke = field.NewInt8(table, "is_revoke")
	c.RevokeTime = field.NewTime(table, "revoke_time")
	c.SendTime = field.NewTime(table, "send_time")
	c.FromDeleteTime = field.NewTime(table, "from_delete_time")
	c.ToDeleteTime = field.NewTime(table, "to_delete_time")
...
func (c *c2CMessage) fillFieldMap() {
	...
	c.fieldMap["from_account_id"] = c.FromAccountId
	c.fieldMap["to_account_id"] = c.ToAccountId
	c.fieldMap["msg_type"] = c.MsgType
	c.fieldMap["data"] = c.Data
	c.fieldMap["status"] = c.Status
	c.fieldMap["is_revoke"] = c.IsRevoke
	c.fieldMap["revoke_time"] = c.RevokeTime
	c.fieldMap["send_time"] = c.SendTime
	c.fieldMap["from_delete_time"] = c.FromDeleteTime
	c.fieldMap["to_delete_time"] = c.ToDeleteTime
}
